    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(csrf ->csrf.disable())
            ...
            .authorizeHttpRequests((requests) -> requests
                .requestMatchers("/post/insert/*","/post/update/*", "/post/delete/*", "/gatpost/insert/*","/gatpost/update/*", "/gatpost/delete/*", "/gatpost/detail/*", "/member/mypage").hasAnyAuthority(UserRole.USER.name(), UserRole.ADMIN.name())
